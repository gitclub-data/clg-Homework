...
printf("please enter 5 to display linked list");
printf("please enter 6 to short merged linked list");
scanf("%d",&j);
switch(j)
{
case 1:
...
void shorting(struct node *q2)
{
	struct node *temp,*temp1,*r,*p,*abc;
	abc=NULL;
	temp=q2;	
while(temp->next!=NULL)
{
